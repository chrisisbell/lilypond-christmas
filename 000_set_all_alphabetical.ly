...
% Header block for the set list
\header {
  title = "All Christmas Music"
  subtitle = "Alphabetical Order, Not Transposed"
  % Remove default LilyPond tagline
  tagline = ##f
}

% Produce a table of contents. (Comment these two lins out to remove.)
